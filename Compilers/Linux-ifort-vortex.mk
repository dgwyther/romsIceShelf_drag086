...
ifdef USE_NETCDF4
    ...
    #NETCDF_INCDIR ?= /apps-build/netcdf/netcdf-fortran-4.2/f90
    #         LIBS := /apps-build/netcdf/netcdf-fortran-4.2/f90
#    NETCDF_INCDIR ?= /apps/netcdf/4.0.1-intel/include
#             LIBS := /apps/netcdf/4.0.1-intel/lib
else
    NETCDF_INCDIR ?= /apps/netcdf/3.6.2-intel/include
    NETCDF_LIBDIR ?= /apps/netcdf/3.6.2-intel/bin
