...
!
        integer  :: icedg2        ! ice-shelf ocean quadratic drag coeff
...
!
        logical :: Lanafile
        character (len=256), dimension(38) :: ANANAME
!
...
!  analytical expression directory.
!
      Rdir="/scratch/dgwyther/romsIceShelf_drag086"
      Hdir="/scratch/dgwyther/romsIceShelf_drag086/ROMS/Include"
      Hfile="icetest.h"
      Adir="/scratch/dgwyther/romsIceShelf_drag086/ROMS/Functionals"
!
!-----------------------------------------------------------------------
