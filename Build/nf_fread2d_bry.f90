...
!     A            2D boundary field to read in (real array)           !
...
!
!***********************************************************************
      FUNCTION nf_fread2d_bry (ng, model, ncname, ncid,                 &
     &                         ncvname, ncvarid,                        &
     &                         tindex, gtype,                           &
     &                         LBij, UBij, Nrec,                        &
     &                         Ascl, Amin, Amax,                        &
...
!
      ...
      integer :: bc, ghost, i, ib, ic, ir, j, rc, tile
      ...
      real(r8), dimension((UBij-LBij+1)*4*Nrec) :: wrk
